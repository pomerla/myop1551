...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->data['text_op_tools'] = $this->language->get('text_op_tools');
        $this->data['text_op_konsultant'] = $this->language->get('text_op_konsultant');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['op_konsultant'] = $this->url->link('octeam/toolset', 'token=' . $this->session->data['token'], 'SSL');
